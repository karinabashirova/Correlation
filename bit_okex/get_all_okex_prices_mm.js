...
create_table = async (iname) => {
    ...
    //console.log(result);
    const logFile = "./okex/okex_" + moment.utc().format("YYYY-MM-DD.HH-mm-ss") + ".csv";
    console.log(logFile);
...
get_deribit_prices_mm = () => {
    ...
    if (process.argv.length < 4)
    {
        ...
        console.log("usage: node get_bit_prices_mm.js <period in sec (0: without timer)> <u_token-DATE> <strike1>, ...");
        return;
    }
